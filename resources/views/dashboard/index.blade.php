                ...
                <div class="card widget widget-stats-large">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="widget-stats-large-chart-container">
                                <div class="card-header">
                                    <h5 class="card-title">SO/TSO Tahunan<span class="badge badge-light badge-style-light">{{date('Y')}}</span></h5>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-4">
                            <div class="widget-stats-large-chart-container">
                                <div class="card-header">
                                    <h5 class="card-title">SO/TSO Bulanan<span class="badge badge-light badge-style-light">{{date('F')}}</span></h5>
                                </div>
                                <div class="card-body">
                                    <div id="chart"></div>
                                </div>
