                                    ...
                                    <tbody>
                                        @forelse ($checksheets as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (isset($item->id_approve_assman))
                                                        {{ $item->assman->name }}
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    ...
                                                    @if (auth()->user()->role != 0)
                                                        @if (
                                                            (auth()->user()->role == 1 && $item->id_approve_assman == null) ||
                                                                (auth()->user()->role == 2 && !$item->id_approve_spv))
                                                            <a href="{{ route('checksheet.approve', $item->id) }}"
