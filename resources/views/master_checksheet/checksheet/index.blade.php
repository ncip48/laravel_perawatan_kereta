            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <li><a class="dropdown-item" href="{{ route('checksheet.filter', $item->id) }}">{{ $item->nama_kereta }}</a>
                        </li>
                        @endforeach
                        </ul>
                    </div> --}}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(auth()->user()->role == 0)
                                        <button type="submit" class="btn btn-sm btn-danger mb-1" data-bs-toggle="modal" data-bs-target="#exampleModal-{{ $item->id }}"><i class="material-icons">delete</i>Hapus</button>
                                        @endif
                                        @if(auth()->user()->role != 0)
                                        <a href="{{ route('checksheet.approve', $item->id) }}" class="btn btn-sm btn-warning mb-1">
