                ...
                <div style="border: 1px solid black;">
                            ...
                            <tr>
                                ...
                                <td style="padding:0px!important">
                                    <table class="tgl">
                                        ...
                                        <tr style="border-bottom: 1px solid black!important;padding-bottom:5px">
                                            <td style="text-align: left;width: 7rem;height:18px">No. Rangkaian Kereta
                                            </td>
                                            <td>:</td>
                    ...
                    <table class="kelas" style="margin-top:5px;padding-left:10px;padding-right:10px">
                        ...
                        @foreach ($detail->categories as $key => $category)
                            <tbody>
                                <tr>
                                    <td style="font-weight:bold;" colspan="{{ count($detail->cars) * 2 + 3 }}">
                                        {{ $key + 1 }}. {{ $category->nama }}
                                    </td>
                                </tr>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="{{ count($detail->cars) * 2 + 3 }}" style="text-align: center">
                                            Tidak
                                            ada
                                            data
                                        </td>
                    ...
                    <table class="kelas" style="margin-top:5px">
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 13px">
                                <h4 style="font-size:10px;font-weight:normal;padding:0px;margin:0px">- Berdasarkan
                                    hasil
                                    pemeriksaan,
                    ...
                    <table class="kelas" style="margin-top:5px">
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 13px">
                                <h4 style="font-size:10px;font-weight:normal;padding:0px;margin:0px">- Pemeriksaan
                                    dilakukan
                                    saat
                                    engine hidup
                                </h4>
